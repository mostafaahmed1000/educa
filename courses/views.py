...
class ContentCreateUpdateView(TemplateResponseMixin, View):
    ...
    def get(self, request, module_id, modele_name, id=None):
        form = self.get_form(self.model, instance=self.obj)
        return self.render_to_response({"form": form, "object": self.obj})

    def post(self, request, module_id, modele_name, id=None):
        form = self.get_form(
        ...
        if form.is_valid():
            ...
            obj.save()
            if not id:
                Content.objects.create(item=obj, module=self.module)
